...
int *number; // thread IDs 0 to MAXTHREAD-1
int *choosing;
...
WORKER worker(void *vthread)
{
	...
	number[thread] = max + 1; // our ticket number is maximum ticket found + 1
	choosing[thread] = 0;
...
int main()
{
	...
	number = new int[maxThread];
	choosing = new int[maxThread];
    //
    // get date
    //
